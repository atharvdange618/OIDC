...
export const Architecture = () => {
  ...
  return (
    <Section className="border-t-4 border-black dark:border-neutral-700 bg-neutral-950 text-white">
      <div className="grid gap-12 lg:grid-cols-2 items-center">
        <div>
          ...
          <p className="mt-6 text-lg font-serif text-neutral-400 leading-relaxed">
          ...
          <div className="mt-10 space-y-6">
            {steps.map((s) => (
              <div key={s.step} className="flex gap-4">
                <div className="shrink-0 flex items-center justify-center size-8 bg-[#60B5FF] text-black font-black rounded-none">
                  {s.step}
                </div>
                <div>
                  <p className="font-black font-sans">{s.title}</p>
                  <p className="text-sm text-neutral-400 font-serif">{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative p-8 bg-neutral-900 border-4 border-neutral-700">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 border-2 border-[#60B5FF] bg-[#60B5FF]/10 text-center">
              ...
              <p className="text-[10px] text-neutral-400 font-mono">Auth Server</p>
            </div>
          </div>
          <div className="mt-8 p-4 border-2 border-dashed border-neutral-700 text-center text-[10px] font-mono text-neutral-500 italic">
