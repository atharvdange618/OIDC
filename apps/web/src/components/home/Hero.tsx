...
export const Hero = () => {
  return (
    <Section className="pt-12 sm:pt-24 pb-16 sm:pb-32 overflow-hidden relative">
      <div className="absolute top-20 right-[-10%] size-[40%] bg-[#60B5FF]/10 rounded-full blur-[120px] -z-10 animate-pulse" />
      <div className="grid gap-12 lg:grid-cols-2 items-center">
        <div>
          <Tag tone="peach" className="mb-6 px-3 py-1.5 text-sm">
            SHIPPING V{APP_VERSION}
          </Tag>
          <h1 className="text-5xl sm:text-7xl font-semibold leading-[1.05] font-sans tracking-tight">
            Ship auth that feels{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-white dark:text-black">
                effortless.
              </span>
              <span className="absolute inset-0 bg-neutral-950 dark:bg-white -rotate-1 z-0 translate-y-2 translate-x-2" />
          ...
          <p className="mt-8 text-xl font-serif leading-relaxed text-muted-foreground max-w-xl">
            ...
            web. PKCE, HTTP-only cookies, full SSO, and Edge-ready middleware -
            without the bloat.
          </p>
        ...
        <div className="relative">
          ...
          <CodeBlock title="Terminal">
            <div className="flex gap-1.5 mb-4">
              <div className="size-3 rounded-full bg-red-400 border border-black" />
              <div className="size-3 rounded-full bg-yellow-400 border border-black" />
              <div className="size-3 rounded-full bg-green-400 border border-black" />
            </div>
